...
<Accordion title="DigiTax is multi-national. Explore other countries here ..." icon="fa-globe">
  ...
  * [DigiTax Kenya API Hub](https://ke.docs.digitax.tech)\
    **This page is DigiTax Kenya API (Version 1) Hub and only applicable if you were using the DigiTax API before[Version 2 was released](https://docs.digitax.tech/changelog/digitax-kenya-api-version-2-release)**. Otherwise we encourage you to use the link above to navigate to the latest API version of DigiTax Kenya 👆.
